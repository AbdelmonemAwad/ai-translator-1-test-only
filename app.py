...
def download_github_release():
    ...
    # Check if GitHub release file exists - prioritize v2.2.1
    release_files = [
        'ai-translator-github-v2.2.1.zip',
        'ai-translator-github-v2.2.0.zip'  # fallback
    ]
    
    for release_file in release_files:
        if os.path.exists(release_file):
            version = '2.2.1' if '2.2.1' in release_file else '2.2.0'
            return send_file(
                release_file,
                as_attachment=True,
                download_name=f'ai-translator-v{version}.zip',
